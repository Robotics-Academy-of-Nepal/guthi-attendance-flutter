import 'package:attendance2/department/leave/services/leave_service.dart';
import 'package:attendance2/department/leave/widgets/custom_slider.dart';
import 'package:attendance2/department/leave/widgets/leave_card.dart';
import 'package:flutter/material.dart';

class DLeaveRequestScreen extends StatefulWidget {
  final int userId;
  const DLeaveRequestScreen({super.key, required this.userId});

  @override
  State<DLeaveRequestScreen> createState() => _LeaveScreenState();
}

class _LeaveScreenState extends State<DLeaveRequestScreen> {
        ...
        body: Column(
          children: [
            ...
            Row(
              ...
              children: [buildSegmentedControl(screenWidth, onTabChanged)],
            ),
